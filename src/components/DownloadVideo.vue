<template>
  <el-main class="main">
    ...
    <el-table
      ...
      border
    >
      <el-table-column prop="order" label="视频分段" width="100">
      </el-table-column>
...
export default Vue.extend({
  ...
  mounted: async function () {
    ...
    console.log(`aid:${videoAid},cid:${videoCid}`);
    ...
    //console.log(videoPlayInfo.data);
    ...
    if (videoPlayInfo.data.dash) {
      videoPlayInfo.data.dash.video.forEach((e) => {
        ...
        this.playUrlDash.video.push({
          stringQN: GetQN(e.id),
          bandWidth: converSize(e.bandwidth),
          mimeType: e.mimeType,
          codecs: e.codecs,
          width: e.width,
          height: e.height,
      ...
      //console.log(this.playUrlDash.video);
